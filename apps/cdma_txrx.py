...
# Generated: Thu Jun  9 17:00:52 2016
##################################################
...
class cdma_txrx(grc_wxgui.top_block_gui):
    ...
    def set_EsN0dB_est(self, EsN0dB_est):
        ...
        self.set_DataEsN0dB_est(self.EsN0dB_est + 10*numpy.log10( 1.0-cp.training_percent/100.0 ) )
        self.set_TrainingEsN0dB_est(self.EsN0dB_est + 10*numpy.log10( cp.training_percent/100.0 ) )
    ...
    def set_symbol_rate(self, symbol_rate):
        ...
        self.set_samp_rate(self.symbol_rate*cp.chips_per_symbol)
    ...
    def set_n_filt(self, n_filt):
        self.n_filt = n_filt
        self.set_n_filt(cp.self.n_filt)
        self._n_filt_static_text.set_value(self.n_filt)
    ...
    def set_drift(self, drift):
        self.drift = drift
        self._drift_slider.set_value(self.drift)
        self._drift_text_box.set_value(self.drift)
        self.channels_channel_model_0.set_timing_offset(1.0+self.drift*1e-6)
    ...
    def set_N0(self, N0):
        self.N0 = N0
        self.channels_channel_model_0.set_noise_voltage((cp.chips_per_symbol*cp.samples_per_chip*self.N0/2)**0.5)
